            ...
            <div class="content-body">
                ...
                <div class="row page-titles mx-0">
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Relatório Clientes</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <form method="POST" action="">
                                ...
                                <br>
                                <button type="submit" class="btn btn-primary mb-2" name="btCadastrar"><i class="fas fa-search"></i></button>
                            </form>
                        </div>
                        <div class="card-body">
